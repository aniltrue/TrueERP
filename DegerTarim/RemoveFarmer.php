...
$sql = "DELETE FROM Farmer WHERE TCID = '" . $TCID . "'";
$rslt = $conn->query($sql);
$conn->close();

if($rslt > 0) 
	echo '<div class="w3-panel w3-green w3-margin w3-animate-opacity"><h3>Tebrikler!</h3><p><b>' . $TCID . '</b> nolu üretici başarıyla silindi.</p></div>';
else

...
<?php
	...
	if(isset($_POST["UserEmail"]) && !empty($_POST["UserEmail"]) && isset($_POST["UserPassword"]) && !empty($_POST["UserPassword"])) {
		...
		die('<div class="w3-panel w3-red w3-margin w3-animate-opacity"><h3>Hata!</h3><br /><p>Yanlış adres.<br />2 saniye içinde yönlendirileceksiniz.</p></div>');
		header("Refresh:2; url=index.php");
	}
?>

<div class="w3-container w3-display-bottomright">
	<p class="w3-text-gray w3-opacity w3-right-align w3-animate-opacity">Anıl Doğru 2017&reg;</p>
</div>

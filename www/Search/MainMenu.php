...
$InputObjects[1]->ComboHelp = new ComboHelp($conn, "SELECT * FROM Pages ORDER BY PageDescription ASC", "PageName", "PageDescription");
...
$SearchObjects[5] = new LinkObject("Güncelle", "PAGE_DEV_MAINMENU_UPDATE", $conn, $userInfo[2], "MainMenuID");
